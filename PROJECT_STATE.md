...
| **2**   | **Onboarding & Profil IA** (V2.4 §L)                         | ✅ LIVE prod       | `OnboardingInterview(+Answer)`, `MemberProfile`                                                    | `/onboarding/interview*`, `/profile`                                       | Boucle de re-profilage périodique ; densité du profil ; smoke batch sur data réelle.                                   |

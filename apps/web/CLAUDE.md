...
L'historique des jalons livres a ete deplace dans [`docs/journal-jalons.md`](docs/journal-jalons.md) pour
garder ce fichier d'instructions court. Le lire a la demande quand l'historique d'un jalon compte.

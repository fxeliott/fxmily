...
vi.mock('@/lib/email/send', () => ({ sendAccessApprovedEmail: sendEmailMock }));
...
describe('rejectAccessRequestAction', () => {
  it('rejects, audits PII-free, and revalidates', async () => {
  ...
  it('surfaces not_pending when the request was already resolved', async () => {

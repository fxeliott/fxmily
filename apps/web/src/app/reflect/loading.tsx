/**
 * S12 — route-level loading skeleton for /reflect (module REFLECT).
 *
 * `force-dynamic` + top-level `await listRecentReflections` froze the previous
...
export default function ReflectLoading() {
  return (
    <main
      ...
      aria-busy="true"
      aria-label="Chargement de tes réflexions"
    >

...
/**
 * Segment error boundary for `/training` (Next.js `error.tsx` convention).
 *
 ...
 *
 * `/training` is the entrainement/backtest area (SPEC §21.7) ; the copy here
 * stays neutral and does not borrow the cyan training tone — an error panel
 * is not a training-mode surface.
 *
    ...
    <div className="mx-auto flex w-full max-w-xl flex-1 flex-col items-center justify-center gap-6 px-4 py-12 text-center">
      ...
      <div>
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight text-[var(--t-1)] sm:text-3xl">
          L&apos;entraînement n&apos;a pas pu s&apos;afficher
        </h1>

  ...
  return (
    <Card className="space-y-5 p-4">
      ...
      <div className="space-y-3">
        <label htmlFor="caffeine-cups" className="t-eyebrow-lg text-[var(--t-3)]">
          Tasses
        </label>
      ...
      <div className="space-y-3 pt-2">
        <label htmlFor="caffeine-last" className="t-eyebrow-lg text-[var(--t-3)]">
  ...
  return (
    <Card className="space-y-4 p-4">
      ...
      <div className="space-y-2">
        <label htmlFor="caffeine-notes" className="t-eyebrow-lg text-[var(--t-3)]">
          Note
        </label>
        <textarea
          id="caffeine-notes"

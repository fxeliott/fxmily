...
const ACTIVE_SNAPSHOT = {
  ...
  counters: {
    ...
    processCompleteRate: 0.8,
    formationFollowedRate: 0.6,
    marketAnalysisDoneRate: 1,
    morningRoutineCompletedRate: 0.8,
    meetingAttendance: { scheduled: 2, completed: 1, rate: 0.5 },
    ...
    sleepQualityMedian: 7,
    meditationMinMedian: 10,
    meditationDaysCount: 3,
    sportDaysCount: 2,
    gratitudeDaysCount: 4,
...
const INACTIVE_SNAPSHOT = {
  ...
  counters: {
    ...
    processCompleteRate: null,
    formationFollowedRate: null,
    marketAnalysisDoneRate: null,
    morningRoutineCompletedRate: null,
    meetingAttendance: { scheduled: 0, completed: 0, rate: null },
    ...
    moodMedian: null,
    stressMedian: null,
    // SPEC §7.10/§30 — inactive member: no routine/lifestyle signal yet.
    sleepQualityMedian: null,
    meditationMinMedian: null,
    meditationDaysCount: 0,
    sportDaysCount: 0,
    gratitudeDaysCount: 0,

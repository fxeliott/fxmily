...
## 24. Rollback J4 migration (`20260529150000_j4_user_token_version`)
...
### 24.1 Pré-requis avant rollback
...
### 24.3 Re-déploiement de l'image pré-J4 + vérification
